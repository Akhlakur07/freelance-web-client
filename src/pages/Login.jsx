...
const Login = () => {
  ...
  const saveUserToBackend = async (payload) => {
    ...
    // backend returns 201 for created, 200 for updated
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      // Upsert user in your backend so Google-first users are created
      const payload = {
            ...
            <div className="hidden md:flex items-center p-10">
              <div className="w-full">
                <div className="mt-2 rounded-2xl ring-1 ring-gray-100 bg-gradient-to-br from-white to-gray-50 shadow-sm p-2">
                  <Lottie animationData={loginLottie} loop className="w-full max-h-[520px]" />
                </div>
              </div>
            </div>
          </div>
